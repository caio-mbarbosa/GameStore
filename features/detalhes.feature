Feature: Detalhes do Jogo

    Como um usuário
    Desejo poder ver mais detalhes de um jogos específico
    Para poder me informar mais sobre o jogo

    Scenario: Acessando a página do jogo 'Overwatch' com sucesso
